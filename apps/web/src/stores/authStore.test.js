...
describe('authStore session lifecycle', () => {
  ...
  it('no longer offers roleplay actions', () => {
    expect(useAuthStore.getState()).not.toHaveProperty('updateRolePlay')
    expect(useAuthStore.getState()).not.toHaveProperty('clearRolePlay')
  })
