...
// returns { imageId, url, size }. Currently retained as a standalone utility
// although the core selfie flow keeps images in-browser.
...
uploadRouter.post('/upload', uploadLimiter, validateBody(uploadSchema), (req, res) => {
